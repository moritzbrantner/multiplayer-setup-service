...
const { LobbySession } = await import("../web/lobby-session.ts");
const { ContentSeederDiscovery } = await import("../web/content-seeder-discovery.ts");
const { CONTENT_MANIFEST_PROTOCOL } = await import("../web/content-verification.ts");
